        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              <img src={logo} alt="ArtFlex IT Logo" className="logo-image" />
            </div>
            <p className="footer-tagline">
              We help ambitious businesses build secure, scalable IT infrastructure
            </p>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/services">Infrastructure Solutions</a></li>
              <li><a href="/services">Cloud Solutions</a></li>
              <li><a href="/services">AMC Services</a></li>
